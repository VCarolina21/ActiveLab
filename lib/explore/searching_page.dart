                  ...
                  : _error != null
                    ? Center(child: Column(
                        ...
                        children: [
                          ...
                          ElevatedButton(onPressed: _loadAllBranches, child: const Text("Coba Lagi")),
                        ],
                      ))
                  : _filteredBranches.isEmpty
                    ? const Center(
                        child: Text("Cabang tidak ditemukan.",
                          style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w500)),
                      )
                  : ListView.builder(
                      padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 10),
                      itemCount: _filteredBranches.length,
                      itemBuilder: (_, index) => _buildBranchCard(_filteredBranches[index]),
                    ),
              ),
            ],
          ),
