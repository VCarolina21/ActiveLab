  ...
  final List<Map<String, String>> _pageData = [
    {
      ...
      "title": "Elevate Your\nFitness",
      "desc":
          "Achieve your fitness goals with our modern gym facilities and professional class instructors.",
    },
    {
      "image": "assets/loginslide2.jpg",
      "title": "Ultimate\nRecovery",
      "desc":
          "Restore your energy with premium services ranging from plunge pools, saunas, to physiotherapy.",
    },
    {
      "image": "assets/loginslide3.png",
      "title": "Seamless\nExperience",
      "desc":
          "Schedule classes, reserve facilities, and enjoy exclusive VIP access with just one touch.",
    },
  ];
