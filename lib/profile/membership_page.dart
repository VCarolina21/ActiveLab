...
class _MembershipPageState extends State<MembershipPage> {
  ...
  final List<Map<String, dynamic>> membershipPlans = [
    ...
    {
      "duration": "3 Month",
      "desc": "Unlimited gym & classes, plus 3x access to VIP sauna and recovery pods.",
      "price": "Rp 500.000",
    },
    {
      "duration": "6 Month",
      "desc": "Unlimited gym & classes, plus 6x access to VIP sauna and recovery pods.",
      "price": "Rp 1.000.000",
    },
    {
      "duration": "12 Month",
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Padding(
                      ...
                      child: Text(
                        "Your transaction was successful. Enjoy your premium access to ActiveLab Gym!",
