import 'dart:ui';
import 'package:activelab/schedule/schedule.dart';
...
class _DetailPageState extends State<DetailPage> {
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // PERBAIKAN: Mengganti Row dengan Wrap agar item otomatis pindah baris jika tidak muat
                  Wrap(
                    spacing: 10,     // Jarak horizontal antar kotak
                    runSpacing: 10,  // Jarak vertikal jika kotak turun ke baris baru
                    children: [
                      _buildFacilityItem("Physiotherapy"),
                      _buildFacilityItem("Yoga"),
                      _buildFacilityItem("Sauna"),
                      _buildFacilityItem("Counseling"),
                    ],
                  ),
                  const SizedBox(height: 30),
  ...
  // PERBAIKAN: Menambahkan padding horizontal agar teks panjang seperti Physiotherapy tidak mepet ke tepi kotak
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => SchedulePage(serviceName: label),
          ),
        );
      },
      child: Container(
